...
declare @quarterenddate datetime = '2021-12-31 00:00:00.000';
...
select * from (
select 
fr.Symbol,sym.Sector,sym.Industry,sym.MarketCapital
...
and tbl.CurrentNetProfit > 0
and tbl.LastYearNetProfit > 0
and tbl.PrevQuarterNetProfit > 0
--and tbl.MarketCapital >= 20000
order by tbl.QoQIncomeChange desc,tbl.PrevQuarterNetProfit desc
